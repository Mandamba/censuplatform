...
public class WorkerStateRepository : BaseRepository<WorkerState>, IWorkerStateRepository
{
    public WorkerStateRepository(ApplicationDbContext context) : base(context)
    {
    }
}